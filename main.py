...
def getRandomFortune():
    ...
    fortunes = [
        "Sniff more things.  The potential is grand.",
        "Call home.  Ask for snacks; a surprise awaits.",
        "Your health will benefit from avoiding the Schnucks on Lindell.",
        "Purell won't save you."
    ]
